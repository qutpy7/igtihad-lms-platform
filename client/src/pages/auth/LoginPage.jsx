          ...
          <form className="flex flex-col gap-4" onSubmit={handleLogin}>
            ...
            <div className="relative">
              ...
              <button
                ...
                aria-label={showPassword ? 'إخفاء كلمة المرور' : 'إظهار كلمة المرور'} className="absolute left-4 top-9 text-clay-muted text-sm hover:text-clay-accent transition-colors"
              >
