      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted hover:text-clay-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-md transition-colors"
