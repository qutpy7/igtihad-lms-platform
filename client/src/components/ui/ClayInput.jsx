      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted hover:text-clay-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-clay-accent rounded-full p-1"
