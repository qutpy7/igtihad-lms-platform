      ...
      <div className="relative">
        ...
        {type === 'password' && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted hover:text-clay-accent transition-colors rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 p-1 flex items-center justify-center"
