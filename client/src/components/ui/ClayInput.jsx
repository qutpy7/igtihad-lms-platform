      ...
      <div className="relative">
        ...
        {type === 'password' && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted hover:text-clay-foreground focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:outline-none rounded-full p-1 transition-colors"
          >
