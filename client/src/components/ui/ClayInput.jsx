      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted text-lg hover:text-clay-accent focus-visible:ring-2 focus-visible:ring-clay-accent focus-visible:outline-none rounded-sm transition-colors"
