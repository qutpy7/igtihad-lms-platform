      ...
      <div className="relative">
        ...
        {isPasswordInput && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted text-sm hover:text-clay-accent transition-colors rounded focus-visible:ring-2 focus-visible:ring-clay-accent focus-visible:outline-none"
