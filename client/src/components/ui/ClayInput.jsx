  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <div className="relative">
        {icon && (
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-clay-muted text-lg pointer-events-none" aria-hidden="true">
            {icon}
          </span>
        )}
        <input
        ...
        {isPassword && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted text-lg hover:text-clay-accent transition-colors focus-visible:ring-2 focus-visible:ring-clay-accent focus-visible:outline-none rounded-full p-1"
