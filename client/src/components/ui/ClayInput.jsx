      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 text-clay-muted text-sm hover:text-clay-accent transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-md"
