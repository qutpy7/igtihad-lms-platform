        ...
        {toasts.map(t => (
          ...
          >
            ...
            <button
              ...
              className="text-slate-400 hover:text-slate-600 transition-colors flex-shrink-0 focus-visible:ring-2 focus-visible:ring-slate-400 rounded-md outline-none p-1"
            >
              <X size={16} />
            </button>
          </div>
