...
## 2024-07-04 - Centralize Common Stateful UX Patterns
**Learning:** Duplicating stateful logic (like show/hide password toggles) across multiple pages leads to inconsistent accessibility implementations and harder maintenance.
**Action:** Integrate common stateful UX patterns natively into the core reusable component library (e.g., `ClayInput`) to enforce consistent accessibility and prevent logic duplication across the application.
